...
#>>>><<<<<<<<<<<<<<<<<
def visualize_NameClass(image, boxes, classes, scores, category_index,
                        instance_masks=None,
                        keypoints=None,
...
def draw_keypoints_on_image(image,
  ...
  if use_normalized_coordinates:
    ...
    print "Keypooint : x",keypoints_x," y ",keypoints_y
...
elapsed = 0
seconds = 15  # 20 S.
def visualize_boxes_and_labels_on_image_array(status,image,
                                              boxes,
                                              classes,
                                              scores,
                                              category_index,
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          if classes[i] in category_index.keys():
            ...
            #print scores[i]
            sc=scores[i]*100
            if (elapsed >= seconds and status == "CHECK" and class_name != "None" and sc>50):
                return class_name
            #>>>>>>>     <<<<<<<<<<
